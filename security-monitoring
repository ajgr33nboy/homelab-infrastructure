...
## Architecture
```
Internet → Cloudflare → ASUS Router (Port 80/443/25565)
                              ↓
                    Nginx Proxy Manager
                              ↓
                    ...
                    [Monitored by Fail2Ban]
                              ↓
                    Prometheus ← Custom Python Exporter
                              ↓
                    Grafana Dashboards
                              ↓
...
# Verify unban notification received ✅
```
...
**Repository:** github.com/ajgreenboy/homelab-infrastructure
